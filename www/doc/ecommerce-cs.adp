<master>
  ...
  <p>Customer Service was originally designed as a submodule of ecommerce to provide call center support.
All interactions logged into same Database table by call center stall who sit at web browsers.</p>

 <h3>Features</h3>


    <p>A complete application which allows customer
      service reps to: </p>
  ...
  <ul>
    <li>Send mail to groups of users based on various criteria (date of last
